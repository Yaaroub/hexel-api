  ...
  return (
    <div className="relative w-full flex flex-col items-center min-h-screen">
      ...
      {activeItem && (
        <h3
          className={`
            select-none text-[#b29d88] font-bold text-3xl transition-all duration-100 ease-[cubic-bezier(0.25,0.1,0.25,1)]
            ${isMoving ? 'opacity-0 pointer-events-none' : 'opacity-100 pointer-events-auto duration-500'}
            max-md:mt-4 max-md:mb-2 max-md:text-center
            md:absolute md:text-4xl md:left-[18%] md:top-1/2 md:-translate-y-1/2 md:translate-x-[20%]
          `}
        >
          {activeItem.title}
        </h3>
      ...
      <canvas
        ...
        ref={canvasRef}
        className="w-full h-[80vh] md:h-screen overflow-hidden outline-none cursor-grab active:cursor-grabbing"
      />
      ...
      {activeItem && (
        <>
          <p
            className={`
              select-none text-[#b29d88] text-xl transition-all duration-100 ease-[cubic-bezier(0.25,0.1,0.25,1)]
              ${isMoving ? 'opacity-0 pointer-events-none' : 'opacity-100 pointer-events-auto duration-500'}
              max-md:mt-2 max-md:mb-4 max-md:text-center max-md:max-w-[80%]
              md:absolute md:text-2xl md:right-[8%] md:top-1/2 md:-translate-y-1/2 md:-translate-x-[90%] md:max-w-[10ch]
            `}
          >
          ...
          <div
            ...
            className={`
              z-10 w-[60px] h-[60px] grid place-items-center bg-[#00ffff] border-[5px] border-black rounded-full cursor-pointer
              transition-all duration-100 ease-[cubic-bezier(0.25,0.1,0.25,1)]
              ${isMoving ? 'opacity-0 pointer-events-none scale-75' : 'opacity-100 pointer-events-auto scale-90 duration-500'}
              max-md:mb-4
              md:absolute md:left-1/2 md:bottom-[2.5em] md:-translate-x-1/2
            `}
          >
            <p className="select-none text-[#b29d88] text-xl relative top-[2px] hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]">
              ↗
            </p>
          </div>
        </>
